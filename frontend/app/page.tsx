...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-bg)' }}>
      ...
      {/* Footer */}
      <footer className="section" style={{ background: 'var(--color-bg-secondary)', borderTop: '1px solid var(--color-border)' }}>
        <div className="container">
          <div className="text-center mb-xl">
            <p className="mb-md" style={{ color: 'var(--color-text-secondary)', fontSize: '1rem' }}>
              Built with ❤️ by <strong style={{ color: 'var(--color-text)' }}>Bharath Kumar K</strong>
            </p>

            {/* Social Links */}
            <div className="flex items-center justify-center gap-md mb-lg" style={{ flexWrap: 'wrap' }}>
              <a
